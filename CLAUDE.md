...
- v2.8 deferred items (spec §12): serial tracking (v2.9), inventory_adjustments + RTV (v2.10), customer-facing warranty, already-expired stock workflow, bulk batch import, batch-level reorder points, email/SMS expiry notifications, mutual-exclusion DB CHECK with `has_serials` (lands with v2.9).
