...
- When v2.10 introduces `user_shop_access.is_active`, this query simplifies to `where not (usa exists and usa.is_active)`; the audit-history clause becomes redundant and is dropped. TODO comment in the SQL file flags this for the v2.10 cleanup.
